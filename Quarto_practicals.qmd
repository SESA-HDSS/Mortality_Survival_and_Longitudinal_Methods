...
Gapminder combines data from multiple sources into unique, coherent time-series that can’t be found elsewhere.[@bryan2015]
...
Rendering into PDF needs installing packages in the terminal and R.
